...
class CurrentAppeal(models.Model):
    ...
    income_call_number = models.CharField(max_length=30, blank=True, null=True, verbose_name='Номер тел. клиента')
    callback_number = models.CharField(max_length=30, blank=True, null=True, verbose_name='Номер для обратной связи')
